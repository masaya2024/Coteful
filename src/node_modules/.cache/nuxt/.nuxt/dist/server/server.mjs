import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, ref, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, h, computed, unref, provide, Suspense, nextTick, mergeProps, Fragment, onServerPrefetch, createElementBlock, cloneVNode, toValue, useSSRContext, withAsyncContext, withCtx, createVNode, resolveComponent, createTextVNode, toDisplayString, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/hattori/Conteful/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/hattori/Conteful/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/hattori/Conteful/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "/Users/hattori/Conteful/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn } from "/Users/hattori/Conteful/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/Users/hattori/Conteful/node_modules/ufo/dist/index.mjs";
import { parse } from "/Users/hattori/Conteful/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/hattori/Conteful/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/hattori/Conteful/node_modules/ohash/dist/index.mjs";
import { klona } from "/Users/hattori/Conteful/node_modules/klona/dist/index.mjs";
...
import { useHead as useHead$1, headSymbol } from "/Users/hattori/Conteful/node_modules/@unhead/vue/dist/index.mjs";
import { debounce } from "/Users/hattori/Conteful/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/400-BNQmduaN.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-yUgoRAOm.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/login-DLALif-g.js")
  },
  {
    name: "reload",
    path: "/reload",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/reload-ByUZ4h_o.js")
  },
  {
    name: "contact",
    path: "/contact",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/contact-CJjfdAXo.js")
  },
  {
    name: "support",
    path: "/support",
    component: () => import("./_nuxt/support-DZ0_WZAa.js")
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import("./_nuxt/projects-CeKRGLpG.js")
  },
  {
    name: "media-new",
    path: "/media/new",
    component: () => import("./_nuxt/new-CHDuNDDj.js")
  },
  {
    name: "media-id",
    path: "/media/:id()",
    component: () => import("./_nuxt/_id_-Dmi4HfPF.js")
  },
  {
    name: "models-new",
    path: "/models/new",
    component: () => import("./_nuxt/new-C9rO3o4v.js")
  },
  {
    name: "entries-new",
    path: "/entries/new",
    component: () => import("./_nuxt/new-DzS47cVv.js")
  },
  {
    name: "media",
    path: "/media",
    component: () => import("./_nuxt/index-I6CQR3gN.js")
  },
  {
    name: "models-id",
    path: "/models/:id()",
    component: () => import("./_nuxt/_id_-B5D9o_vy.js")
  },
  {
    name: "api-settings",
    path: "/api-settings",
    component: () => import("./_nuxt/api-settings-DQmIy0TB.js")
  },
  {
    name: "entries-id",
    path: "/entries/:id()",
    component: () => import("./_nuxt/_id_-CKY8HOLn.js")
  },
  {
    name: "models",
    path: "/models",
    component: () => import("./_nuxt/index-DbrEkWPl.js")
  },
  {
    name: "entries",
    path: "/entries",
    component: () => import("./_nuxt/index-CQFPiGz6.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BwEKE-rL.js").then((m) => m.default || m)),
  public: defineAsyncComponent(() => import("./_nuxt/public-DRlllW_K.js").then((m) => m.default || m))
};
...
export {
  ...
  useWorkspaceSession as a,
  useReloadOverlay as b,
  createError as c,
  useAsyncData as d,
